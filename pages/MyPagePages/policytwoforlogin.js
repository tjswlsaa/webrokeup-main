...
<View style={{height:"90%", backgroundColor:"white", marginHorizontal:"5%", marginVertical:"10%"}}>
                ...
                marginTop:60, marginHorizontal:"10%"
                        ...
                        <ScrollView style={{marginHorizontal:"10%",marginVertical:"10%"}}>
                            ...
                            필미필미(이하 "회사" 또는 "필미필미"이라 함)은 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 개인정보보호법, 통신비밀보호법, 전기통신사업법, 등 정보통신서비스제공자가 준수하여야 할 관련 법령상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보취급방침을 정하여 이용자 권익 보호에 최선을 다하고 있습니다.
                            {"\n"}
                            {"\n"}
...
회사는 회원가입(또는 서비스 가입) 및 각종 서비스의 제공을 위해 필미필미 서비스 최초 이용시 다음과 같은 개인정보 수집하고 있습니다.
{"\n"}
...
{"\n"}{"\n"}
4. 개인정보의 파기 절차 및 방법{"\n"}
회사는 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다. 필미필미 앱 사용자의 사용정보를 수집 및 보유하지 않습니다. 앱 삭제시 더 이상 위 권한을 사용하지 않습니다. {"\n"}
...
7. 개인정보 자동 수집 장치의 설치/운영 및 그 거부에 관한 사항 {"\n"}
필미필미 서비스는 개인정보 자동 수집 장치(쿠키)를 이용하지 않습니다{"\n"}
...
필미필미 서비스 내에 링크되어 있는 웹사이트들이 개인정보를 수집하는 행위에 대해서는 본 "필미필미 개인정보취급방침"이 적용되지 않음을 알려 드립니다.{"\n"}
{"\n"}{"\n"}
10. 고지의 의무
{"\n"}{"\n"}
