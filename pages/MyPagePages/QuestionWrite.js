    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <StatusBar style="white" />
        {/* <ImageBackground style={{height: "100%", resizeMode: "cover",}} source={{ uri: bookBackground }} > */}
              ...
              <ScrollView style={{backgroundColor:"white", marginHorizontal:"5%", marginTop:"5%"}} scrollEnabled={true}>
                ...
                <View style={{flex:1, flexDirection:"row", alignItems:"center",  height: realScreen*0.15, marginHorizontal:"5%"}}>
                        ...
                        <View style={{ flex:15, height: realScreen*0.08, justifyContent:"center", width:"100%"}}>
                            ...
                            <TextInput style={{ fontSize: 18, fontWeight: "600", marginHorizontal: "2%",lineHeight:23 }}
            ...
            <Text style={{ fontSize: 15, marginHorizontal: "8%", marginVertical: "2%" }}>{question.intro}</Text>
          </View>
          <View style={{backgroundColor: "#fafafa", marginHorizontal: "3%"}}>
            <View style={{ height: realScreen * 0.12, justifyContent: "center" }}>
              <Text style={{ marginHorizontal: "5%", fontSize: 15, fontWeight: "600"}}>{question.Q1}</Text>
            </View>
            <TextInput style={{ marginHorizontal: "7%", fontSize: 15, height: realScreen * 0.2, marginTop: "2%", marginBottom: "3%" }}
              multiline={true} placeholder="답변을 입력하세요"
              returnKeyType="done"
              onChangeText={text2 => setText2(text2)}
            />
            <View style={{ height: realScreen * 0.12, justifyContent: "center" }}>
              <Text style={{ marginHorizontal: "5%", fontSize: 15, fontWeight: "600"}}>{question.Q2}</Text>
            </View>
            <TextInput style={{ marginHorizontal: "7%", fontSize: 15, height: realScreen * 0.2, marginTop: "3%", marginBottom: "3%" }}
              multiline={true} placeholder="답변을 입력하세요"
              returnKeyType="done"
              onChangeText={text3 => setText3(text3)}
            />
            <View style={{ height: realScreen * 0.1, justifyContent: "center" }}>
              <Text style={{ marginHorizontal: "5%", fontSize: 15, fontWeight: "600"}}>{question.Q3}</Text>
            </View>
            <TextInput style={{ marginHorizontal: "7%", fontSize: 15, height: realScreen * 0.2, marginTop: "3%", marginBottom: "3%" }}
              multiline={true} placeholder="답변을 입력하세요"
              returnKeyType="done"
          ...
          <View style={{ height: realScreen * 0.03, justifyContent: "center" }}>
          </View>
          <View style={{ marginHorizontal: "5%" }}>
            <Text style={{ marginLeft: "3%", color: "grey" }}> 오늘의 감정 빛깔은 </Text>
          </View>
          <View style={{ fontSize: 15, height: realScreen * 0.08, marginTop: "3%", marginBottom: "3%", flexDirection: "row", alignSelf: "center", }}>
            <View style={{ flex: 1, flexDirection: "row", marginHorizontal: "8%", marginVertical: "3%" }}>
...
async function savePage() {
  ...
  if (text2 == ""){
    Alert.alert("첫 번째 답변을 입력해주세요");
    return;
  }
  if (text3 == ""){
    Alert.alert("두 번째 입력해주세요");
    return;
  }
  if (text4 == ""){
    Alert.alert("세 번째 입력해주세요");
    return;
  }
