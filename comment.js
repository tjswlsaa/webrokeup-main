...
,    View, Text,Keyboard, FlatList, Button, TextInput,ScrollView, TouchableOpacity, SafeAreaView, NativeModules  } from 'react-native'
...
var commentKey = Math.random().toString().replace(".","");
...
function Comment({route}) {
   ...
   // console.log('Comment()');
    ...
    useEffect(() => {
       // console.log('comments.js (1), chapters: ',chapters);
        firebase_db
    ...
    const onCommentSend = () => {
      ...
      // console.log('comments.js (2), chapters: ',chapters);
...
const ChapterComment = (props)=> {
    ...
    const likeRef = firebase_db.ref(`book/${bookKey}/chapters/${chapterKey}/comments/${commentKey}/likes/`);
